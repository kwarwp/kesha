...
{'date': 'Thu Oct 10 2019 18:11:51.883 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
...
'''},
{'date': 'Sat Oct 12 2019 14:59:01.559 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135

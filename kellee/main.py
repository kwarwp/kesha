...
class Tabuleiro:
    ...
    def _3da_(self):
        ...
        cubos1 = [box(pos=(-0.2, 1.2, x * (1.2) - 0), size=(1, 1, 1), **bloco1) for x in range(2)] #Os da primeira em cima
        cubos2 = [box(pos=(y * (1.2) - 1.4, 0, 0),size=(1, 1, 1),**bloco)for y in range(3)] #Os da segunda linha
        cubo = box(pos=(-0.2,   0, -1.2), size=(1,1,1) , **bloco) #Antigo Cubo 5 na 2 linha
        cubo2 = box(pos=(1.0, -1.2, 0.0), size=(1,1,1) , **bloco1) #Antigo Cubo 1 na 3 linha

...
TypeError: rate() missing 1 positional argument: ['func']
'''},
{'date': 'Wed Sep 26 2018 17:19:11.154 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
TypeError: rate() missing 1 positional argument: ['func']
'''},
{'date': 'Wed Sep 26 2018 17:44:45.804 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135
...
TypeError: rate() missing 1 positional argument: ['func']
'''},
{'date': 'Mon Oct 07 2019 14:17:28.200 GMt-0300 (Horário Padrão de Brasília) -X- SuPyGirls -X-',
'error': '''Traceback (most recent call last):
  module _core.main line 160
    dialog.action(lambda *_: self.start()
  module _core.supygirls_factory line 135

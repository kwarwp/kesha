...
area3= box(pos=(0,0,0), size=(4,2,0.2))
area4= box(pos=(3,1,0), size=(2,4,0.2))
area5= box(pos=(-2,2,0), size=(4,2,0.2))

area6= box(pos=(1,2,0), size=(2,2,0.2))
area7= box(pos=(1,-1.5,0), size=(2,1,0.2))
area8= box(pos=(1,-2.5,0), size=(2,1,0.2))
area9= box(pos=(0,0,0), size=(4,2,0.2))
area10= box(pos=(0,0,0), size=(4,2,0.2))
area4= box(pos=(0,0,0), size=(4,2,0.2))

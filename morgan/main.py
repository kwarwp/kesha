...
CEST_IMG, DOG_IMG, BASE_IMG, CENA_IMG, PRED_IMG = f"{IGR}qtw6IoO.png", f"{IGR}ZQ9SSMz.png", f"{IGR}7Wh2Px0.png", f"{IGR}zRGdYRp.gif", f"{IGR}vL9kR9Y.png"
#CEST_IMG, DOG_IMG, RET, CENA_IMG, INICIO_IMG  = f"{IGR}qtw6IoO.png", f"{IGR}ZQ9SSMz.png", f"{IGR}HUkZFHm.png", f"{IGR}zRGdYRp.gif"
...
#dog_IMG, menino e menina (futuramente)
...
class Basico:
    def __init__(self):
        self.cena = cena = Cena(CENA_IMG)
        self.casa = Predio(PRED_IMG, cena=cena)
        self.casa.entra(self.cena)
        self.base0 = Plataforma(BASE_IMG, y=100, cena=cena)
        self.base1 = Plataforma(BASE_IMG, y=500, cena=cena)
        self.base0.destino, self.base1.destino = self.base1, self.base0 
        self.cesta = Veiculo(CEST_IMG, destino=self.base1, cena=cena)
        self.cesta.entra(self.base0)
        self.doggie = Personagem(DOG_IMG, destino=self.cesta, cena=cena)
